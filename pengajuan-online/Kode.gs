...
* CONFIG
*************************/
const PROJECT_ID = 'alpine-inkwell-486307-n2';
const LOCATION = 'us';
const DATASET_ID = 'app_pengajuan';
const TABLE_MAHASISWA = 'data_mahasiswa';
const SPREADSHEET_ID = '1VnUSOPOpSR5N8b7j2PfGyFj2dEw29WXdU9UqWrMut8s';
...
const sql = "SELECT nim, nama, prodi FROM `" + PROJECT_ID + "." + DATASET_ID + "." + TABLE_MAHASISWA + "` WHERE nim = " + nimInt + " LIMIT 1";
